...
<script type="text/javascript" src="JS/Bistri-config.js"> </script>
	...
	<table width="640px" height="360px" border="3px">
	<tr>
		<td  width="640px" height="360px">
		<video id="video-container" style="position:absolute; width:640px; height:360px;z-index: -1;"></video>
	...
	<tr>
    	...
    	<input type="button" value="send" id="send"  size="30" onclick="SendData()" >
   		<div id="dialog" style="display:none">please draw something </div>   
